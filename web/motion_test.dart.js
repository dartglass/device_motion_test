...
DeviceMotionEvent: {"": "Event;accelerationIncludingGravity="},
...
["motion_test.dart", "motion_test.dart", , {
main: function() {
  var t1 = window;
  $.EventStreamProvider_devicemotion.forTarget$2$useCapture;
  t1 = new $._EventStream(t1, $.EventStreamProvider_devicemotion._eventType, false);
...
main_closure: {"": "Closure;",
  call$1: function($event) {
    ...
    document.querySelector("#motion_X").textContent = $.toString$0(t1.get$accelerationIncludingGravity($event).x);
    document.querySelector("#motion_Y").textContent = $.toString$0(t1.get$accelerationIncludingGravity($event).y);
    document.querySelector("#motion_Z").textContent = $.toString$0(t1.get$accelerationIncludingGravity($event).z);
  }
}},
1],
]);
...
$.EventStreamProvider_devicemotion = new $.EventStreamProvider("devicemotion");
...
// Native classes
$.defineNativeMethods("DOMError|DeviceAcceleration|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList", $.Interceptor);
...
//# sourceMappingURL=motion_test.dart.js.map
//@ sourceMappingURL=motion_test.dart.js.map
